...
public class ExpensesController {
	...
	public ResponseEntity<Response<Map<String, Object>>> createExpense(@RequestBody final Expense expense) {
		final HttpStatus httpStatus = HttpStatus.CREATED;
		final Map<String, Object> data = new HashMap<>();
		data.put("expenseId", this.expensesService.createExpense(expense));
		final Response<Map<String, Object>> response = new Response<>(httpStatus.value(), Response.DEFAULT_MESSAGE,
				data);
